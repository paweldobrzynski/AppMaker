...
The bulk materialization runs in `plugin/appmaker/scripts/init-materialize.sh`. This skill owns user confirmation, upgrade-path decisions, and optional integrations.
