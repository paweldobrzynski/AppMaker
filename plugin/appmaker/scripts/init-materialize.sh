...
# Directory tree.
mkdir -p appmaker/{templates,skills,memory/raw,memory/wiki,context,backlog/done,features/archive,reviews,checklists,diagnostics,decisions,security,afk,phase-plans,debt,hooks}
