...
Status: 19 skills (15 core + afk + status + token-audit + next). v0.2.16 — CLAUDE.md pointer + decisions.md lifecycle. Test harness covers hooks + glossary-extract + version SoT.
