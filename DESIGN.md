...
Status: 19 skills (15 core + afk + status + token-audit + next). v0.2.15 — per-slice review gate in `/appmaker:next`. Test harness covers hooks + glossary-extract + version SoT.
