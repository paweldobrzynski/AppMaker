...
Status: 18 skills (15 core + afk + status + token-audit). v0.2.12 — pivot to "governance layer ABOVE Claude Code runtime". Test harness covers hooks + glossary-extract + version SoT.
